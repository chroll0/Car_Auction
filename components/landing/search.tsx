...
const Search = () => {
  ...
  return (
    <motion.div
      ...
      className="shadow-3xl border rounded-3xl flex flex-col px-12 py-6 gap-4"
    >
      ...
      <form className="flex flex-col gap-8 justify-between items-end flex-wrap pb-4 md:flex-row w-full">
        <label htmlFor="mark" className="flex flex-col w-full md:w-auto">
          <span className="font-medium text-[16px] text-black mb-2">Mark</span>
          <input
            id="mark"
            type="text"
            name="mark"
        ...
        <label htmlFor="model" className="flex flex-col w-full md:w-auto">
          <span className="font-medium text-[16px] text-black mb-2">Model</span>
          <input
            id="model"
            type="text"
            name="model"
        ...
        <label htmlFor="year" className="flex flex-col w-full md:w-auto">
          <span className="font-medium text-[16px] text-black mb-2">Year</span>
          <input
            id="year"
            type="text"
            name="year"
        ...
        <label htmlFor="more" className="flex flex-col w-full md:w-auto">
          <span className="font-medium text-[16px] text-black mb-2">More</span>
          <input
            id="more"
            type="text"
            name="more"
...
export default SectionWrapper(Search, "");
